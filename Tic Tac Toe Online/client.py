...
message_button = tk.Button(wind, text="Client: O" , width=15,disabledforeground="black")
...
def createButtons():
    ...
    for r in range(1,4):
        for c in range(1,4):
            buttons[f"btn_{counter}"] = tk.Button(wind, text="", width=5,command=partial(clicked, counter), disabledforeground="black")
